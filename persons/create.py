...
def create(event, context):
    ...
    if 'first_name' not in data and 'last_name' not in data and 'is_gay' not in data:
        ...
        return {'statusCode': 422,
                'body': json.dumps(
                    {'error_message': 'Couldn\'t create the person item because required fields not in JSON payload.'})}
    #
    ...
    a_person.save()
    #
    logging.info('PersonMode {} {} successfully created'.format(a_person.first_name, a_person.last_name))
    # create a response
